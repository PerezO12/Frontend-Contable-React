...
export var Dashboard = function () {
    ...
    var quickActions = [
        ...
        },
        {
            ...
            icon: (<svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
        </svg>), color: 'bg-purple-500 hover:bg-purple-600',
            roles: [UserRole.ADMIN, UserRole.CONTADOR],
        },
        {
        ...
        </svg>), color: 'bg-indigo-500 hover:bg-indigo-600',
            roles: [UserRole.ADMIN, UserRole.CONTADOR],
        },
        {
            title: 'Terceros',
    ...
    return (<>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {dashboardStats.map(function (stat, index) { return (<Card key={index} className="p-6">
            <div className="flex items-center">
              <div className={"p-3 rounded-lg ".concat(stat.bgColor, " ").concat(stat.color)}>
                {stat.icon}
              </div>
              <div className="ml-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className={"ml-2 text-sm ".concat(stat.trend === 'up' ? 'text-green-600' : 'text-red-600')}>
                    {stat.change}
                  </span>
                </div>
              </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {quickActions
            .filter(function (action) { return hasAccess(action.roles); })
            .map(function (action, index) { return (<Card key={index} className="p-6 hover:shadow-lg transition-shadow cursor-pointer" onClick={function () { return navigate(action.path); }}>
                <div className="text-center">
                  <div className={"inline-flex p-3 rounded-lg text-white ".concat(action.color, " mb-4")}>
                    {action.icon}
                  </div>
