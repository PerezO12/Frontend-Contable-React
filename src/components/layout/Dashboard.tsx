      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <Card>
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Sistema Contable</h3>
            <p className="mt-1 text-sm text-gray-500">
              El sistema de autenticación está funcionando correctamente.
            </p>
            <p className="mt-2 text-xs text-gray-400">
              Los módulos contables estarán disponibles en la siguiente fase del desarrollo.
            </p>
          </div>
        </Card>        {/* Información adicional para debugging */}
        {import.meta.env.DEV && (
          <Card className="mt-6">
