...
export var AccountEditPage = function () {
    var navigate = useNavigate();
    var id = useParams().id;
    var _a = useAccount(id), account = _a.account, loading = _a.loading, error = _a.error;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            ...
            <li>
              <button onClick={function () { return navigate("/accounts/".concat(account.id)); }} className="text-blue-600 hover:text-blue-800">
                {account.name}
              </button>
            </li>
            <li className="text-gray-500">/</li>
        ...
        <AccountForm initialData={{
            ...
            notes: account.notes
        }} onSuccess={handleSuccess} onCancel={handleCancel} isEditMode={true} accountId={account.id}/>
      </div>
    </>);
};
