...
export const CostCenterAnalysis: React.FC<CostCenterAnalysisProps> = ({
  costCenter,
  onClose
}) => {
  ...
  const { analysis, loading, error, fetchAnalysis } = useCostCenterAnalysis();
  ...
  const getMarginBgColor = (margin: number) => {
    ...
    if (margin >= 0) return 'bg-orange-50 border-orange-200';
      ...
      {analysis && !loading && (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card>
              <div className="card-body text-center">
                <div className={`text-2xl font-bold mb-2 ${
                  parseFloat(analysis.net_result) >= 0 ? 'text-green-600' : 'text-red-600'
                }`}>
            ...
            <Card>
              <div className={`card-body text-center border-2 ${getMarginBgColor(analysis.margin_percentage)}`}>
                <div className={`text-2xl font-bold mb-2 ${getMarginColor(analysis.margin_percentage)}`}>
            ...
            <div className="card-body">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`text-sm font-medium ${
                        analysis.cost_center.is_active ? 'text-green-600' : 'text-gray-600'
                      }`}>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`text-sm font-medium ${getMarginColor(analysis.margin_percentage)}`}>
                      ...
                      <div 
                        ...
                        style={{ 
                          width: parseFloat(analysis.total_income) > 0 
                            ? `${Math.min((parseFloat(analysis.total_expenses) / parseFloat(analysis.total_income)) * 100, 100)}%`
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                <div className="space-y-2">
                  ...
                  {analysis.margin_percentage >= 10 && analysis.margin_percentage < 20 && (
                  ...
                  {analysis.margin_percentage >= 0 && analysis.margin_percentage < 10 && (
