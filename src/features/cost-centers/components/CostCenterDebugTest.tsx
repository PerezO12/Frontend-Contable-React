 ...
 */
export const CostCenterDebugTest: React.FC = () => {
  const { costCenters, total, loading, error, refetch } = useCostCenters();
  ...
  return (
    <div className="p-4 border border-gray-300 rounded-lg bg-yellow-50">
      ...
      <div className="space-y-2">
        ...
        <div>
          <strong>Centros recibidos:</strong> {costCenters?.length || 0}
        </div>
