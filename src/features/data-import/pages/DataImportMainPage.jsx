...
export function DataImportMainPage() {
    ...
    var _a = React.useState(null), selectedDataType = _a[0], setSelectedDataType = _a[1];
    ...
    if (!selectedDataType) {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">          <div className="text-center mb-8">
            ...
            <div className="bg-gradient-to-r from-purple-500 to-blue-600 text-white rounded-lg p-4 mb-6">
              ...
              <button onClick={function () { return navigate('/import-export/generic'); }} className="mt-3 bg-white text-purple-600 px-6 py-2 rounded-md font-medium hover:bg-gray-100 transition-colors duration-200">
          ...
          {/* Importar Cuentas */}
          <div onClick={function () { return setSelectedDataType('accounts'); }} className="cursor-pointer bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all duration-200">
          ...
          {/* Importar Asientos */}
          <div onClick={function () { return setSelectedDataType('journal_entries'); }} className="cursor-pointer bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-green-500 hover:shadow-lg transition-all duration-200">
            <div className="flex items-center mb-4">
          ...
          {/* Importar NFe (NUEVO) */}
          <div onClick={function () { return navigate('/import-export/nfe'); }} className="cursor-pointer bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-orange-500 hover:shadow-lg transition-all duration-200">
            <div className="flex items-center mb-4">
          ...
          <div onClick={function () { return navigate('/import-export/generic'); }} className="cursor-pointer bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-purple-500 hover:shadow-lg transition-all duration-200">
            <div className="flex items-center mb-4">
    ...
    return (<div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <nav className="flex items-center space-x-2 text-sm text-gray-500">
                ...
                <button onClick={handleBackToSelection} className="text-gray-600 hover:text-gray-900 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Wizard */}
        <DataImportWizard dataType={selectedDataType} onComplete={handleImportComplete}/>
      </div>
    </div>);
}
