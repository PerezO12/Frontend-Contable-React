// Tipos para el sistema de importación genérico basado en metadatos
// Similar al sistema de Odoo
...
export interface ColumnMapping {
  column_name: string;
  field_name?: string; // null = ignorar columna
  default_value?: string;
}
...
export interface ValidationSummary {
  total_rows?: number;  // Para compatibilidad con frontend anterior
  total_rows_analyzed?: number;  // Nombre que usa el backend
  valid_rows: number;
  rows_with_errors: number;
  rows_with_warnings: number;
  most_common_errors?: Record<string, number>;  // Para compatibilidad con frontend anterior
  error_breakdown?: Record<string, number>;  // Nombre que usa el backend
}
...
export interface ImportResult {
  ...
  processing_time_seconds?: number;  // Can be undefined/null during processing
  error_summary?: Record<string, number>;  // Can be undefined/null
  detailed_errors?: PreviewRowData[];  // Can be undefined/null
