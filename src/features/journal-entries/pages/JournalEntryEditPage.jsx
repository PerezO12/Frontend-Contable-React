...
export var JournalEntryEditPage = function () {
    ...
    var id = useParams().id;
    var _a = useJournalEntry(id), entry = _a.entry, loading = _a.loading, error = _a.error;
    ...
    if (entry.status !== 'draft') {
        ...
        <Card>
          <div className="card-body text-center py-8">
            ...
            <button onClick={function () { return navigate("/journal-entries/".concat(entry.id)); }} className="text-blue-600 hover:text-blue-800">
    ...
    return (<>
      ...
      </div>      <JournalEntryEditForm entryId={entry.id} onSuccess={handleSuccess} onCancel={handleCancel}/>
    </>);
};
