...
const mockCashFlowResponse: CashFlowResponse = {
  success: true,
...
const mockBasicCashFlowResponse: CashFlowResponse = {
  ...mockCashFlowResponse,
  narrative: {
    ...mockCashFlowResponse.narrative,
    liquidity_analysis: undefined,
    projections: undefined
  }
};

export const CashFlowDemo: React.FC = () => {
  const [demoMode, setDemoMode] = useState<'basic' | 'advanced'>('advanced');
  const [showComparison, setShowComparison] = useState(false);

  const currentReport = demoMode === 'advanced' ? mockCashFlowResponse : mockBasicCashFlowResponse;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          <div className="flex gap-2">
            <Button
              variant={demoMode === 'basic' ? 'primary' : 'secondary'}
            ...
            <Button
              variant={demoMode === 'advanced' ? 'primary' : 'secondary'}
      ...
      {/* Vista principal */}
      {!showComparison && (
        <CashFlowViewer report={currentReport} />
      )}
