...
var testReportWithMissingData = {
    ...
    table: {
        sections: [
            ...
            // Section with undefined items to test defensive programming
            {
                ...
                items: undefined, // This will test our defensive checks
                total: '0.00'
            }
        ],
        totals: {
    ...
    narrative: {
        ...
        key_insights: undefined, // This will test our defensive checks
        recommendations: ['Mantener el flujo positivo'],
        financial_highlights: undefined // This will test our defensive checks
    }
};
var testReportWithCompleteData = {
    success: true,
    report_type: 'flujo_efectivo',
    generated_at: '2025-06-10T10:00:00Z',
    period: {
...
export var TestReportViewer = function () {
    var _a = React.useState('missing'), testCase = _a[0], setTestCase = _a[1];
    return (<div className="p-6 space-y-6">
      <div className="flex space-x-4 mb-6">
        <button onClick={function () { return setTestCase('missing'); }} className={"px-4 py-2 rounded ".concat(testCase === 'missing'
            ? 'bg-red-500 text-white'
            : 'bg-gray-200 text-gray-700')}>
          Test Missing Data (Should Not Crash)
        </button>
        <button onClick={function () { return setTestCase('complete'); }} className={"px-4 py-2 rounded ".concat(testCase === 'complete'
      ...
      <div className="border p-4 rounded">
        ...
        {testCase === 'missing' ? (<ReportViewer report={testReportWithMissingData}/>) : (<ReportViewer report={testReportWithCompleteData}/>)}
      </div>
    </div>);
};
