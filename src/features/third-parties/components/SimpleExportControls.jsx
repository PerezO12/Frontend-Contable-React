...
export var SimpleExportControls = function (_a) {
    var selectedThirdPartyIds = _a.selectedThirdPartyIds, thirdPartyCount = _a.thirdPartyCount, onExportStart = _a.onExportStart, onExportEnd = _a.onExportEnd;
    ...
    var handleExport = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('🚀 Iniciando exportación de terceros...', { selectedThirdPartyIds: selectedThirdPartyIds, thirdPartyCount: thirdPartyCount, exportFormat: exportFormat });
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ThirdPartyService.exportThirdParties(selectedThirdPartyIds, exportFormat)];
                case 2:
                    blob = _a.sent();
                    timestamp = new Date().toISOString().slice(0, 19).replace(/[:-]/g, '');
                    fileName = "terceros_".concat(thirdPartyCount, "_registros_").concat(timestamp, ".").concat(exportFormat);
                    console.log('💾 Iniciando descarga del archivo:', fileName);
                    // Descargar archivo
                    ExportService.downloadBlob(blob, fileName);
                    success("\u2705 Se exportaron ".concat(thirdPartyCount, " tercero").concat(thirdPartyCount === 1 ? '' : 's', " exitosamente en formato ").concat(exportFormat.toUpperCase()));
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
    ...
    return (<div className="flex items-center space-x-3">
      ...
      {/* Botón de exportar */}
      <Button onClick={handleExport} disabled={isExporting || selectedThirdPartyIds.length === 0} variant="primary" className="flex items-center space-x-2">
        {isExporting ? (<>
            <Spinner size="sm"/>
      ...
      {selectedThirdPartyIds.length > 0 && (<span className="text-sm text-gray-600">
