...
export var ThirdPartyCreatePage = function () {
    var navigate = useNavigate();
    var _a = useCreateThirdParty(), createThirdParty = _a.createThirdParty, loading = _a.loading, error = _a.error;
    ...
    var handleSubmit = function (data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, createThirdParty(data)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        showSuccess("Tercero \"".concat(result.name, "\" creado exitosamente"));
                        navigate("/third-parties/".concat(result.id));
                    }
                    return [3 /*break*/, 3];
                case 2:
                    err_1 = _a.sent();
    ...
    return (<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <ThirdPartyForm mode="create" onSubmit={handleSubmit} onCancel={handleCancel} loading={loading}/>
    </div>);
};
